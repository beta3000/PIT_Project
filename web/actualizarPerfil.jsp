    ...
    <div class="row">
        <form action="actualizarPerfil.action" class="form-horizontal" name="" method="POST">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputIdPerfil" placeholder="ID Perfil"
                           name="perfilBean.idPerfil" value="<s:property value="perfilBean.idPerfil"/>" readonly>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputNombrePerfil" placeholder="Nombre Perfil"
                           name="perfilBean.nombrePerfil" value="<s:property value="perfilBean.nombrePerfil"/>"
                           required>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputDescripcionPerfil" placeholder="Descripcion"
                           name="perfilBean.descripcionPerfil"
                           value="<s:property value="perfilBean.descripcionPerfil"/>" required>
                </div>
            </div>
            <div class="form-group">
