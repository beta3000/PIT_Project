...
<div class="container">
    <div class="row">
        ...
        <p class="text-center">Completar el siguiente formulario para actualizar un Producto en el Sistema</p>
    </div>
</div>
<!-- Fin cabezera-->
...
<div class="container">
    <div class="row">
        <form action="actualizarProducto.action" class="form-horizontal" name="" method="POST">
            <div class="form-group">
                <label for="inputIdProducto" class="col-sm-4 control-label">ID de Producto</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputIdProducto" placeholder="ID Producto"
                           name="productoBean.idProducto" value="<s:property value="productoBean.idProducto"/>"
                           readonly>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputNombreProducto" placeholder="Nombre Producto"
                           name="productoBean.nombreProducto" value="<s:property value="productoBean.nombreProducto"/>"
                           required>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputPrecioProducto" placeholder="Precio Producto"
                           name="productoBean.precioProducto" value="<s:property value="productoBean.precioProducto"/>"
                           required>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputDescripcionProducto" placeholder="Descripcion"
                           name="productoBean.descripcionProducto"
                           value="<s:property value="productoBean.descripcionProducto"/>" required>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputTasaProducto" placeholder="Tasa Producto"
                           name="productoBean.tasaProducto" value="<s:property value="productoBean.tasaProducto"/>"
                           required>
                </div>
            </div>
            <div class="form-group">
